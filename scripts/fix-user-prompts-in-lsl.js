...
/**
 * Fix User Prompts in LSL Files
 * Extracts actual user prompts from Claude transcript and updates LSL files
 */
...
function buildUserMessageLookup(transcriptPath) {
  console.log('📖 Reading Claude transcript...');
...
async function main() {
  ...
  console.log('🔧 Fixing user prompts in LSL files from today...\n');
