...
const MemoryFallbackService = require('../fallbacks/memory-fallback');
const BrowserFallbackService = require('../fallbacks/browser-fallback');
const LoggerFallbackService = require('../fallbacks/logger-fallback');
...
class CoPilotAdapter extends AgentAdapter {
  ...
  async startMemoryService() {
    ...
    console.log('✓ Memory service (LevelGraph) started');
    
    // Import existing knowledge if available
