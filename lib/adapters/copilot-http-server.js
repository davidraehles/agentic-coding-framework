...
class CopilotHTTPServer {
    ...
    async updateKnowledge(entity) {
        ...
        if (this.adapter.memoryService) {
            await this.adapter.memoryService.createEntity(completeEntity);
        }
    ...
    async searchKnowledge(query) {
        ...
        const results = await this.adapter.memoryService.searchEntities(query);
        return results;
    }
    ...
    async getRelevantContext(prompt) {
        ...
        for (const keyword of keywords) {
            const results = await this.adapter.memoryService.searchEntities(keyword);
